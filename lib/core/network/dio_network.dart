...
class DioNetwork {
  ...
  static Future<void> clearTokens() => _authInterceptor?.clearTokens() ?? Future.value();
  static String? get accessToken => _authInterceptor?.accessToken;
  static String? get refreshToken => _authInterceptor?.refreshToken;
  static Future<void> loadTokensFromStorage() => _authInterceptor?.loadTokens() ?? Future.value();
  static Future<bool> isAuthenticated() => _authInterceptor?.isAuthenticated() ?? Future.value(false);
}
