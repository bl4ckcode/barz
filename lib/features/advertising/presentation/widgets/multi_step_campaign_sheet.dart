...
/// Multi-step campaign creation sheet replacing the old single-sheet form.
///
/// 5-step immersive workflow inspired by Meta Ads Manager, Google Ads, TikTok:
/// Step 1: Goal & Name
      ...
      transitionBuilder: (context, anim1, anim2, child) {
        return BackdropFilter(
          filter: ImageFilter.blur(
            sigmaX: math.max(0.001, anim1.value * 10.0),
            sigmaY: math.max(0.001, anim1.value * 10.0),
          ),
...
class _MultiStepCampaignSheetState extends State<MultiStepCampaignSheet>
  ...
  void _initBarName() {
    ...
    if (sessionState is SessionReady && sessionState.session.activeBar != null) {
      _barName = sessionState.session.activeBar.toString();
      _prefillName();
    }
  }
  ...
  String get _stepTitle {
    return switch (_currentStep) {
      0 => 'Qual é seu objetivo?',
      1 => 'Quanto deseja investir?',
      2 => 'Como sua campanha vai aparecer?',
      3 => 'Quem deve ver sua campanha?',
      4 => 'Revisar e Lançar',
      _ => '',
    };
  }
  ...
  String get _stepSubtitle {
    return switch (_currentStep) {
      0 => 'Escolha o que melhor descreve sua campanha',
      1 => 'Defina seu orçamento total e distribua entre os canais',
      2 => 'Personalize os criativos da sua campanha',
      3 => 'Defina o público-alvo e alcance geográfico',
      4 => 'Confira os detalhes antes de lançar',
      _ => '',
    };
  }

  String get _continueLabel => _currentStep == 4 ? 'Lançar Campanha' : 'Continuar';
        ...
        children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: isSelected ? barzGold : Colors.white,
                        ),
                      ),
                      const SizedBox(height: 4),
                      Text(
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              hintText: 'Ex: Meu Bar — Promoção 1/1',
              hintStyle: TextStyle(
  ...
  Widget _buildStep2Budget() {
    final totalPct = _distribution.fold<double>(0.0, (sum, d) => sum + d.percentage);
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintText: '500',
              hintStyle: TextStyle(color: dobarColors.labelSecondary.withValues(alpha: 0.5)),
              filled: true,
              fillColor: const Color(0xFF0A0A0A),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(10),
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 11,
              color: dobarColors.labelSecondary.withValues(alpha: 0.7),
            ),
          ),
          ...
          Center(
            child: TextButton.icon(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Distribuição inteligente aplicada!'),
                    backgroundColor: barzGold,
                    duration: Duration(seconds: 1),
                  ),
                );
              },
              icon: const Icon(LucideIcons.wand2, size: 16, color: barzGold),
              label: const Text(
          ...
          ...CampaignPlacement.values.asMap().entries.map((entry) {
            ...
            final index = _distribution.indexWhere((d) => d.placement == placement);
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: isEnabled ? barzGold.withValues(alpha: 0.3) : const Color(0xFF2C2C2C),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => _togglePlacement(index >= 0 ? index : _distribution.length),
                        child: AnimatedContainer(
                          duration: const Duration(milliseconds: 200),
                          width: 44,
                          height: 24,
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(12),
                            color: isEnabled ? barzGold : const Color(0xFF2C2C2C),
                          ),
                          child: AnimatedAlign(
                            duration: const Duration(milliseconds: 200),
                  ...
                  if (isEnabled) ...[
                    ...
                    Row(
                      children: [
                        GestureDetector(
                          onTap: () => _onDistributionChanged(index, pct - 5),
                          child: Container(
                            width: 32,
                            height: 32,
                            decoration: BoxDecoration(
                        ...
                        Expanded(
                          child: SliderTheme(
                            data: SliderTheme.of(context).copyWith(
                              ...
                              thumbColor: barzGold,
                              overlayColor: barzGold.withValues(alpha: 0.2),
                              trackHeight: 4,
                            ),
                            child: Slider(
                              value: pct,
                              ...
                              max: 100,
                              divisions: 20,
                              onChanged: (v) => _onDistributionChanged(index, v),
                            ),
                          ),
                        ),
                        GestureDetector(
          ...
          if (!isValid) ...[
            ...
            Container(
              ...
              child: Row(
                children: [
                  const Icon(LucideIcons.alertTriangle, size: 16, color: errorRed),
                  ...
                  TextButton(
                    ...
                    child: const Text(
                      'Ajustar',
                      style: TextStyle(color: barzGold, fontSize: 11),
                    ),
                  ),
                ],
              ),
            ...
            Container(
              ...
              child: Row(
                children: _distribution.map((d) {
                  ...
                  final color = colors[
                      CampaignPlacement.values.indexOf(d.placement) % colors.length];
                  return Expanded(
  ...
  Widget _buildStep3Creative() {
    final hasBanner = _distribution.any((d) => d.placement == CampaignPlacement.banner);
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 10,
                        color: dobarColors.labelSecondary.withValues(alpha: 0.6),
                      ),
                    ),
                  ],
                ),
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () => setState(() => _selectedCta = cta.value),
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: isSelected ? barzGold : const Color(0xFF2C2C2C),
                        width: isSelected ? 1.5 : 1,
                      ),
                      color: isSelected ? barzGold.withValues(alpha: 0.1) : Colors.transparent,
                    ),
                    child: Center(
                      child: Text(
                        cta.label,
                        style: TextStyle(
                          ...
                          color: isSelected ? barzGold : dobarColors.labelSecondary,
                        ),
                      ),
                    ),
                  ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(LucideIcons.eye, size: 14, color: barzGold),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              colors: [Color(0xFFFFDF73), Color(0xFFFFC000)],
                            ),
                            borderRadius: BorderRadius.circular(6),
                          ),
                          child: Text(
                            CtaOption.options
                                .firstWhere((o) => o.value == _selectedCta)
                                .label,
                            style: const TextStyle(
                              fontSize: 11,
                              fontWeight: FontWeight.bold,
          ...
          GestureDetector(
            onTap: () => setState(() => _promoteHappyHour = !_promoteHappyHour),
            child: Container(
              padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(
                color: const Color(0xFF121212),
              ...
              child: Row(
                children: [
                  Icon(
                    LucideIcons.clock,
                    size: 18,
                    color: _promoteHappyHour ? barzGold : dobarColors.labelSecondary,
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                  ...
                  Icon(
                    _promoteHappyHour
                        ...
                        : LucideIcons.circle,
                    size: 22,
                    color: _promoteHappyHour ? pixGreen : dobarColors.labelSecondary,
                  ),
                ],
              ),
            ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(LucideIcons.mapPin, size: 16, color: barzGold),
              const SizedBox(width: 8),
              Text(
                'Alcance geográfico',
                style: TextStyle(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('1 km', style: TextStyle(fontSize: 10, color: Colors.white38)),
                    const Text('50 km', style: TextStyle(fontSize: 10, color: Colors.white38)),
                  ],
                ),
              ],
            ),
          ...
          Row(
            children: [
              const Icon(LucideIcons.users, size: 16, color: barzGold),
              const SizedBox(width: 8),
              Text(
                'Faixa etária',
                style: TextStyle(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('18', style: TextStyle(fontSize: 10, color: Colors.white38)),
                    const Text('65+', style: TextStyle(fontSize: 10, color: Colors.white38)),
                  ],
                ),
              ],
            ),
          ...
          _buildToggleOption(
            ...
            subtitle: 'Exibir campanha apenas em horários de maior movimento (sextas e sábados à noite, happy hour)',
            value: _peakHoursOnly,
            onChanged: (v) => setState(() => _peakHoursOnly = v),
          ),
          if (_peakHoursOnly) ...[
            const SizedBox(height: 8),
            Container(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: barzGold.withValues(alpha: _budgetOptimizerEnabled ? 0.3 : 0.0),
              ),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(LucideIcons.zap, size: 16, color: barzGold),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                    ...
                    GestureDetector(
                      onTap: () => setState(() => _budgetOptimizerEnabled = !_budgetOptimizerEnabled),
                      child: AnimatedContainer(
                        duration: const Duration(milliseconds: 200),
                        width: 44,
                        height: 24,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(12),
                          color: _budgetOptimizerEnabled ? pixGreen : const Color(0xFF2C2C2C),
                        ),
                        child: AnimatedAlign(
                          duration: const Duration(milliseconds: 200),
                ...
                if (_budgetOptimizerEnabled) ...[
                  ...
                  Row(
                    children: [
                      const Icon(LucideIcons.checkCircle, size: 12, color: Color(0xFF00B37E)),
                      const SizedBox(width: 6),
                      const Text(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: value ? barzGold.withValues(alpha: 0.3) : const Color(0xFF2C2C2C),
          ),
        ),
        child: Row(
          children: [
            Icon(icon, size: 18, color: value ? barzGold : dobarColors.labelSecondary),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Icon(LucideIcons.receipt, size: 20, color: barzGold),
                  ],
                ),
                ...
                _buildReviewRow(
                  ...
                  label: 'Alcance',
                  value: '${_radiusKm.round()} km · ${_ageMin.round()}-${_ageMax.round()} anos',
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(LucideIcons.trendingUp, size: 16, color: barzGold),
                    const SizedBox(width: 8),
                    Text(
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: _buildMetricBox(
                        label: 'Cliques',
                        value: '~${_formatCompact(ep.estimatedClicks)}',
                      ),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: _buildMetricBox(
                        label: 'Impressões',
                        value: '~${_formatCompact(ep.estimatedImpressions)}',
                      ),
                    ),
                  ],
                ),
              ...
              Expanded(
                child: TextButton(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Icon(LucideIcons.save, size: 16, color: Colors.white70),
                      const SizedBox(width: 8),
                      Text(
                        'Salvar Rascunho',
                        style: TextStyle(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _currentStep > 0
                          ...
                          : dobar.labelSecondary.withValues(alpha: 0.3),
                    ),
                  ),
                ),
              ),
              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: _isLaunching ? dobar.surfaceElevated : null,
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Flexible(
                  child: Text(
                    ...
                    style: TextStyle(
                      color: date != null
                          ? Colors.white
                          : dobarColors.labelSecondary.withValues(alpha: 0.6),
                      fontSize: 13,
                      fontWeight:
                ...
                const Icon(LucideIcons.calendar, size: 16, color: barzGold),
              ],
            ),
          ),
        ),
  ...
  static String _goalLabel(CampaignGoal g) {
    return switch (g) {
      ...
      CampaignGoal.promotion => 'Promover Oferta Especial',
      CampaignGoal.fullPresence => 'Presença Total',
    };
  }
