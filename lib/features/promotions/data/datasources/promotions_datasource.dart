...
abstract class PromotionsDatasource {
  ...
  Future<List<PromotionModel>> getPromotionsByDiscountType(
    PromoDiscountType type,
  );
  Future<List<PromotionModel>> getPromotionsByBar(
    int barId, {
    bool activeOnly = true,
  });
...
class PromotionsNetworkDatasource implements PromotionsDatasource {
  ...
  Future<List<PromotionModel>> getPromotions({
    ...
    try {
      ...
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get promotions',
  ...
  Future<List<PromotionModel>> getPromotionsByDiscountType(
    ...
    try {
      ...
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get promotions by type',
        e.response?.statusCode,
      );
    }
  }
  ...
  Future<List<PromotionModel>> getPromotionsByBar(
    ...
    try {
      ...
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get bar promotions',
        e.response?.statusCode,
      );
    }
  }
  ...
  Future<PromotionModel> getPromotionById(int id) async {
    try {
      final response = await dio.get(
        '${ApiEndpoints.baseUrl}${ApiEndpoints.promotion(id)}',
      );
      return PromotionModel.fromJson(response.data);
    } on DioException catch (e) {
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get promotion',
        e.response?.statusCode,
      );
    }
  }
  ...
  Future<List<OfferModel>> getOffers() async {
    try {
      final response = await dio.get(
        '${ApiEndpoints.baseUrl}${ApiEndpoints.offers}',
      );
      return (response.data as List)
      ...
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get offers',
        e.response?.statusCode,
      );
    }
  }
  ...
  Future<List<OfferModel>> getOffersByPartnerId(int partnerId) async {
    try {
      ...
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get partner offers',
        e.response?.statusCode,
      );
    }
  }
  ...
  Future<OfferModel> getOfferById(int id) async {
    try {
      final response = await dio.get(
        '${ApiEndpoints.baseUrl}${ApiEndpoints.offers}/$id',
      );
      return OfferModel.fromJson(response.data);
    } on DioException catch (e) {
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to get offer',
        e.response?.statusCode,
      );
    }
  }
  ...
  Future<OfferModel> redeemOffer(int offerId) async {
    try {
      final response = await dio.post(
        '${ApiEndpoints.baseUrl}${ApiEndpoints.offers}/$offerId/redeem',
      );
      return OfferModel.fromJson(response.data);
    } on DioException catch (e) {
      throw ServerException(
        e.response?.data?['detail'] ?? 'Failed to redeem offer',
        e.response?.statusCode,
      );
    }
  }
