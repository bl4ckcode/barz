...
class _PaymentMethodsCardState extends State<PaymentMethodsCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final mutedColor = widget.isDark ? textSecondary : textSecondary;
                      ...
                      children: [
                        ...
                        Text(
                          widget.savedCards.isNotEmpty
                              ? '${widget.savedCards.length} saved card${widget.savedCards.length > 1 ? "s" : ""}'
                ...
                Padding(
                  ...
                  child: AnimatedCrossFade(
                    firstChild: AddNewCardWorkflow(
                      ...
                      onClose: () => setState(() => _showAddCard = false),
