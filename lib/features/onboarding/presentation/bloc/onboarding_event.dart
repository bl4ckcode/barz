...
sealed class OnboardingEvent with _$OnboardingEvent {
  ...
  const factory OnboardingEvent.selectUserType(String userType) =
      SelectUserType;

  /// Select country
  const factory OnboardingEvent.selectCountry(String countryCode) =
      SelectCountry;

  /// Detect country from phone number
  const factory OnboardingEvent.detectCountryFromPhone(String phoneNumber) =
